...
//kontol
        ...
        case 'menfesconfirm': {
 				XeonBotInc.sendMessage(q, {text: `Sudah Di Confirmasi Nih Menfess nyaa🤭`})
				 m.reply(`Terimakasih Menfess Telah Diterima.`)
				}
               break
case 'chatwith2': {
if (m.isGroup) return m.reply('Fitur Tidak Dapat Digunakan Di Dalam Group!')
XeonBotInc.sendMessage(q+'@s.whatsapp.net', {text: `Sudah Di Confirmasi Nih Menfess nyaa ntar lagi dia balas🤭`})
